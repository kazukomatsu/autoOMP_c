...
static float p[65UL][65UL][129UL];
static float a[4UL][65UL][65UL][129UL];
static float b[3UL][65UL][65UL][129UL];
static float c[3UL][65UL][65UL][129UL];
static float bnd[65UL][65UL][129UL];
static float wrk1[65UL][65UL][129UL];
static float wrk2[65UL][65UL][129UL];
static int imax;
static int jmax;
static int kmax;
static float omega;
...
#pragma omp parallel for reduction (+:gosa)
    for (i = 1; i < (imax - 1); i++) 
      for (j = 1; j < (jmax - 1); j++) 
        for (k = 1; k < (kmax - 1); k++) {
